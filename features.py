...
class MolSentence:
    """Class for storing mol2vec_6000_down_sampling sentences in pandas DataFrame
    """
...
def mol2sentence(mol, radius):
    ...
    # merge identifiers alternating radius to sentence: atom 0 radius0, atom 0 radius 11, etc.
    identifiers_alt = []
    for atom in dict_atoms:  # iterate over atoms
